...
namespace DigitalRuby.RainMaker
{
    public class BaseRainScript : MonoBehaviour
    {
        ...
        protected virtual void Start()
        {
            ...
            audioSourceRainLight.AudioSource.outputAudioMixerGroup = audioMixerGroup;
            audioSourceRainMedium.AudioSource.outputAudioMixerGroup = audioMixerGroup;
            audioSourceRainHeavy.AudioSource.outputAudioMixerGroup = audioMixerGroup;
